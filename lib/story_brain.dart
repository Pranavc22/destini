...
class StoryBrain {
  ...
  void nextStory(int userChoice) {
    if (userChoice == 1 && _storyNo == 0) {
      _storyNo = 2;
    } else if (userChoice == 2 && _storyNo == 0) {
      _storyNo = 1;
    } else if (userChoice == 1 && _storyNo == 1) {
      _storyNo = 2;
    } else if (userChoice == 2 && _storyNo == 1) {
      _storyNo = 3;
    } else if (userChoice == 1 && _storyNo == 2) {
      _storyNo = 5;
    } else if (userChoice == 2 && _storyNo == 2) {
      _storyNo = 4;
    }
    if (userChoice == 3) restart();
  }
